...
class TestOptions:
    ...
    def initialize(self):
        self.parser.add_argument('--dataset', type=str, default='bbps-0-1',
        ...
        self.parser.add_argument('--test_dir', type=str, default='', help='models are saved here')

        # added by Vajira
        # self.parser.add_argument('--sub_dir', type=str, default='bbps-0-1', help="sub directory (category) to convert into inpainted images")
        self.parser.add_argument('--data_dir', type=str, default='', help='the file storing testing file paths')
        self.parser.add_argument('--mask_dir', type=str , default="", help="A folder with mask images")
        self.parser.add_argument('--mask_file_list', default="", help="file with all paths to masks")
        
        self.parser.add_argument('--out_dir_img', type=str, default='', help='main directory to output inpainted images')
        self.parser.add_argument('--out_dir_mask', type=str, default='', help='main directory to output maks images')
        # self.parser.add_argument('--out_dir_', type=str, default='/work/vajira/DATA/polyps_inpainting/hyper-kvasir-stroke/mask_csv/split_0', help='main directory to output csv files')
