...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_file', type=str, default='/work/vajira/DATA/hyper_kvasir/data_new/splits/split_0/normal-cecum', help='the file storing testing file paths')
