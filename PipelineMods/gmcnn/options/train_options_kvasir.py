...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='Polyps',
                                 help='dataset of the experiment.')
        self.parser.add_argument('--data_file', type=str, default='/work/vajira/DATA/hyper_kvasir/data_new/unlabelled/file_list.flist', help='the file storing training image paths')
        ...
        # added by Vajira
        # self.parser.add_argument("--py_file",default=os.path.abspath(__file__)) # store current python file

        self.parser.add_argument("--out_dir", 
                default="/work/vajira/DATA/polyps_inpainting/output",
                help="Main output dierectory")

        self.parser.add_argument("--tensorboard_dir", 
                default="/work/vajira/DATA/polyps_inpainting/tensorboard",
...
class TrainOptionsGivenMask:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='Polyps',
                                 help='dataset of the experiment.')
        self.parser.add_argument('--data_file', type=str, default='/work/vajira/DATA/hyper_kvasir/data_new/segmented/data/segmented-images/file_list.flist', help='the file storing training image paths')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2')
        self.parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--load_model_dir', type=str, default='', help='pretrained models are given here')
        self.parser.add_argument('--phase', type=str, default='train')
        ...
        self.parser.add_argument('--mask_file_list', type=str, default='', 
                            help='Mask file list used for training')
        ...
        self.parser.add_argument("--data_root", 
                default="/work/vajira/DATA/hyper_kvasir/data_new/segmented/data/segmented-images",
                help="Data root")
